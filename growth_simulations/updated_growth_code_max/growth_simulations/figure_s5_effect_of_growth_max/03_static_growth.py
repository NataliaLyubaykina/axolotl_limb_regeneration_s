...
from euler_scheme_1d_with_growth import two_morph_gstatic as two_morph
...
def loop():
    ...
    g_to_test = np.array([0.5, 1, 2, 5]) * beta * L0

    output_folder = 'growth_simulations/figure_s5_effect_of_growth/results_of_numerics/two_morph_static/dynamics/'
