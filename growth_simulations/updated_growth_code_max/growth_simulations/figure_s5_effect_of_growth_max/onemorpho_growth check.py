...
from euler_scheme_1d_with_growth import one_morph 
...
def loop():
    ...
    w     = 0.5 * lam
    L0    = 1.8 * (x0 + w)
    threshold_growth = 0.26

    small_number = 1e-6
    L_final_g0=one_morph.Lfinal(threshold_growth, x0, lam, alpha, w, beta, D)
    all_L_final_rel=[]
    all_ndx=[100,200,300,500,600,700,900]
    for ndx in all_ndx:
        dx   = L0 / ndx
...
# th_0.28_g_5
# 100 0.4325286891249665
# 200 0.43247697559301435
# 300 0.43248349759708204
# 500 0.43247840964204265
# 600 0.43246597003561765
# 700 0.4324603307359592
# 900 0.43247180074838554
# 1100 0.4324628553629936
# 1500 0.43246575660033654
# 2000 0.43246424590887006
# 2500 0.4324634149546216
# 3000 0.4324633780594008
# 4000 0.43246087576404485
